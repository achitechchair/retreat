...
<div id="content"> 
	...
	<!--Chart-box-->
		<table class="table" cellpadding="0" cellspacing="0" border="0" style="padding-bottom:0px; margin:0px;">
			<tr>
				<td>					
					<a href="cancel-registrations.php?index=List" class="btn btn-inverse"> <i class="icon-step-backward"></i> Back to Registration</a>
				</td>
			</tr>
		</table>
		...
		<div class="row-fluid">
			<div class="widget-box">
               ...
               <div class="control-group">
                        ...
                        <option value="Single Bed"<?php if($f->getValue($row['admin_room_type']) == 'Single Bed') echo ' selected';?>>Single Bed</option>
                        <option value="Queen"<?php if($f->getValue($row['admin_room_type']) == 'Queen') echo ' selected';?>>Queen</option>
                        <option value="King"<?php if($f->getValue($row['admin_room_type']) == 'King') echo ' selected';?>>King</option>
                        <option value="Double"<?php if($f->getValue($row['admin_room_type']) == 'Double') echo ' selected';?>>Double</option>
                        <option value="Twin Bed"<?php if($f->getValue($row['admin_room_type']) == 'Twin Bed') echo ' selected';?>>Twin Bed</option>
                     </select>
                  </div>                  
					</div> 
              
               <div class="control-group">
						<label class="control-label">Room Allotted:</label>
						<div class="controls">							
               ...
               <div class="control-group">
						<label class="control-label">Souvenir Distribution:</label>
						<div class="controls">							
               ...
               <div class="control-group">
						<label class="control-label">Goodie Bag:</label>
						<div class="controls">							
