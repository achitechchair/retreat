				...
				<table class="table table-bordered <?php //if($records > 0) echo ' data-table';?>" width="100%">
					...
					<tbody>
						...
						<!--<div id="myAlert<?php echo $row['seo_tkd_id'];?>" class="modal hide">
							...
							<div class="modal-footer"> <a class="btn btn-primary" href="<?php echo CP;?>?index=List&action=Delete&Id=<?php echo $seo_tkd_id;?>">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
						</div>-->
					<?php 
							}
						} else { 
