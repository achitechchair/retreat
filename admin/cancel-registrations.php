...
<div id="content"> 
	...
	<div id="content-header">
		<div id="breadcrumb"> <a href="javascript:;" title="" class="tip-bottom"><i class="icon-th-large"></i> Manage Cancel Registration</a></div>
	</div>
	<!--End-breadcrumbs-->
	<?php 
	if($index == 'List')
	{
		...
		$sql = "SELECT a.*, b.`email_id`, b.`phone` FROM `".T."` AS a, `".T2."` AS b 
				  WHERE a.`reg_id`=b.`reg_id` AND a.`mark_for_deleted`='No' AND a.`status`='Cancel' ORDER BY a.`reg_id` ASC";		
		$res = $db->get($sql);
			...
			<input type="hidden" name="btnseq" value="ok">	
				<table class="table table-bordered <?php if($records > 0) echo ' data-table';?>" width="100%">
					<thead>
                  	...
                  	<th width="7%"><div align="left">Reg No#</div></th>
                     <th width="18%"><div align="left">Email</div></th>
                     <th width="11%"><div align="left">Phone</div></th>   
                     <th width="5%"><div align="center">Persion</div></th>
                     <th width="7%"><div align="center">Price</div></th> 
                     <th width="9%"><div align="center">Pay Mode</div> 
                     <th width="11%"><div align="center">Pay Status</div>                     
                     <th width="8%"><div align="center">Reg.Date</div></th>
                     <th width="8%"><div align="center">Cancel Date</div></th>
					...
					<tbody>
                     ...
                     <td><div align="center"> <?php echo date("m/d/Y", strtotime($row['cancel_dt']));?></div>
                     <!--<td><div align="center"><a href="cancel-registration-admin-notes.php?index=List&ref_reg_id=<?php echo $reg_id;?>"><img src="images/Tutorials.gif" width="16" height="16" border="0" /></a></div></td>-->
                     <td><div align="center">
	...
	?>	
		...
		<div class="row-fluid">
            ...
            <div class="widget-content" style="padding-left:50px !important;">	
               ...
               <div class="views">
						<b>Cancel At:</b> <?php echo date("m/d/Y h:i A", strtotime($row['cancel_dt']));?>	
					</div>
               
               <?php
						if(empty($row['cancellation_charges']) == FALSE)
						{
					?>
					<div class="views">
						<b>Cancellation Charges:</b> $<?php echo $f->getValue($row['cancellation_charges']);?>
					</div>
					<?php
						}
               ?>    
