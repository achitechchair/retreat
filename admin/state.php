					...
					<tbody>
                     ...
                     <td><div align="center"><a href="<?php echo CP;?>?index=Edit&Id=<?php echo $state_id;?>" class="btn btn-primary btn-mini">Edit</a> <a href="#myAlert<?php echo $state_id;?>" data-toggle="modal" class="btn btn-danger btn-mini">Delete</a></div></td>
						...
						<div id="myAlert<?php echo $row['state_id'];?>" class="modal hide">
							...
							<div class="modal-footer"> <a class="btn btn-primary" href="<?php echo CP;?>?index=List&action=Delete&Id=<?php echo $state_id;?>&file=">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
						</div>
					<?php 
							}
						} else { 
			...
			<div class="widget-box">
            	...
            	<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="state_name" id="state_name" class="span11 required" value="<?php echo $f->POST_VAL('state_name');?>" />
						</div>
					</div>
