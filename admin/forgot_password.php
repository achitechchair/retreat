<?php
	...
	{
		$flag = 0;
		$your_email_address = $f->setValue($_POST['your_email_address']);
	...
	<form action="<?php echo CP;?>" method="post" id="frmForgotPassword" name="frmForgotPassword">		
		<div class="controls">
			<div class="main_input_box"> <span class="add-on bg_lo"><i class="icon-envelope"></i></span>
				<input name="your_email_address" type="text" id="your_email_address" placeholder="E-mail address" value="<?php echo $f->POST_VAL('your_email_address');?>" class="input2 required email" />
			</div>
		</div>
		<div class="form-actions"> <span class="pull-left"><a href="<?php echo WEBSITE_URL;?>/index.php" class="flip-link btn btn-success" id="to-login">&laquo; Back to login</a></span> <span class="pull-right">
