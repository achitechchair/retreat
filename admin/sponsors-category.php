<?php
	...
	define("T","tbl_sponsors_category");
	$index = $_GET['index'];
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="content"> 
	...
	<div id="content-header">
		<div id="breadcrumb"> <a href="javascript:;" title="" class="tip-bottom"><i class="icon-th-large"></i> Manage Categorys</a></div>
	</div>
	<!--End-breadcrumbs-->
	<?php 
	if($index == 'List')
			...
			<input type="hidden" name="btnseq" value="ok">	
				<table class="table table-bordered <?php if($records > 0) echo ' data-table';?>" width="100%">
					<thead>
						<tr> 
                  	<th width="2%">Seq.</th>
                     <th width="82%"><div align="left">Category Name</div></th>
					...
					<tbody>
						<?php
						 ...
						 ?>
						<tr>
                  	<td><div align="center"><input name="seq<?php echo $cat_id;?>" type="text" value="<?php echo $row['display_order'];?>" size="2"  class="input1 Sequ numeric" /></div></td>
                     ...
                     <td><div align="center"><a href="<?php echo CP;?>?index=Edit&Id=<?php echo $cat_id;?>" class="btn btn-primary btn-mini">Edit</a> <a href="#myAlert<?php echo $cat_id;?>" data-toggle="modal" class="btn btn-danger btn-mini">Delete</a></div></td>
						</tr>
						<div id="myAlert<?php echo $row['cat_id'];?>" class="modal hide">
							...
							<div class="modal-footer"> <a class="btn btn-primary" href="<?php echo CP;?>?index=List&action=Delete&Id=<?php echo $cat_id;?>&file=">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
						</div>
					<?php 
							}
						} else { 
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">	            				
					<div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="cat_title" id="cat_title" class="span11 required" value="<?php echo $f->POST_VAL('cat_title');?>" />
						</div>
					</div>
