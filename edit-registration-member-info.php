            ...
            <div class="register_area">
              ...
              <div style="font-size:25px; color: #2F2D9B; font-weight: 600; text-transform: uppercase; padding-bottom: 20px;">Guest <?php echo ($i + 1);?></div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4"><p class="style1">Age (on July 4th, 2024)<span>*</span></p>
                  ...
                  <div class="col-md-12"><p class="style1">Is this person participating in Youth Activities? (Only if age is 18 to 29) <span>*</span></p>
                     <div><input name="youth_activity_<?php echo $i;?>" type="radio" value="Yes" class="youth_activity_<?php echo $i;?>"<?php if($f->getValue($row_mem['youth_activity']) == 'Yes') echo ' checked';?> disabled />  YES &nbsp;&nbsp;&nbsp; <input name="youth_activity_<?php echo $i;?>" type="radio" value="No" class="youth_activity_<?php echo $i;?>"<?php if($f->getValue($row_mem['youth_activity']) == 'No') echo ' checked';?> disabled />  NO</div>
                  </div>
                  <div class="clear"></div>                 
                  ...
                  <div id="id_youth_activity_<?php echo $i;?>">
                     ...
                     <div class="col-md-6"><p class="style1">Are you interested in participating in youth dance <span>*</span></p>
                        <select name="youth_dance[]" class="input3 text_disable all_youth_activity_<?php echo $i;?>" disabled>
                           <option value="">Select</option>
                           <option value="Yes"<?php if($f->getValue($row_mem['youth_dance']) == 'Yes') echo ' selected';?>>YES</option>
                           <option value="No"<?php if($f->getValue($row_mem['youth_dance']) == 'No') echo ' selected';?> disabled>NO</option>
                        </select>
                     </div>
                     <div class="col-md-6"><p class="style1">T Shirt Size <span>*</span></p>
                        <select name="tshirt_size[]" class="input3 text_disable all_youth_activity_<?php echo $i;?>" disabled>
                           <option value="">Select</option>
                     ...
                     <div class="col-md-6"><p class="style1">Phone Number of the Youth Member <span>*</span></p><input name="phone[]" type="tel" value="<?php echo $f->getValue($row_mem['phone']);?>" placeholder="" class="input3 text_disable all_youth_activity_<?php echo $i;?>" disabled /></div>
                     <div class="col-md-6"><p class="style1">Email of the Youth Member <span>*</span></p><input name="email[]" type="email" value="<?php echo $f->getValue($row_mem['email']);?>" placeholder="" class="input3 text_disable email all_youth_activity_<?php echo $i;?>" disabled /></div>
              		</div>
               </div>
