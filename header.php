               ...
               <ul>
                    <li><a href="javascript:;"<?php if($CurrentPage == "index.php") echo ' class="active"';?>>Retreat 2024</a>
                         <ul>
                              ...
                              <?php  ?>
                              <li><a href="<?php echo MAIN_WEBSITE_URL;?>/registration-faq">Registration FAQ</a></li>
						<li><a href="<?php echo MAIN_WEBSITE_URL;?>/stage-program-faq.php">Stage Program FAQ</a></li>
                              <li><a href="<?php echo MAIN_WEBSITE_URL;?>/sponsors">Sponsors</a></li>
                              <li><a href="<?php echo MAIN_WEBSITE_URL;?>/updates">Updates</a></li>
                              <?php  ?>
