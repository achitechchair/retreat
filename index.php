	    ...
	    <div class="signature_left">
			<div class="signature_left_content">
				<div class="signature_left_content_area">
					<div class="signature_text1" style="font-size:30px; line-height:1.16;">REGISTRATION HAS CLOSED BUT YOU CAN STILL ATTEND THE EVENT WITH THE FOLLOWING RESTRICTIONS.</div>
					<div class="signature_text2">
						<p><span>&#10803;</span> Cost per person attending is <strong>$545</strong> which includes banquet dinner on Thursday, <strong>July 4th</strong>.</p> 
						<p><span>&#10803;</span> Room is not included.</p>
						<p><span>&#10803;</span> You photo or name won't get into the Retreat Souvenir book.</p>
						<p><span>&#10803;</span> Please reach out to <a href="mailto:miretreat.registration@achi.org" style="color:#FFF; text-decoration:underline;">miretreat.registration@achi.org</a> for further assistance.</p>
					</div>
					<!--<div class="signature_text3">Eight more weeks to go</div>-->
					<?php /*?><div class="button1"><a href="<?php echo MAIN_WEBSITE_URL;?>/registration-home">Register Now</a></div><?php */?>	
				</div>
			</div>
			<div class="clear"></div>
		</div>
