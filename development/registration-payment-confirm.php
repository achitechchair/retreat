<?php
	...
	{	
		...
		$sql_profile = "SELECT * FROM `tbl_reg_profile_info` WHERE `status`='Active' AND `reg_id`=".$reg_id;
		...
		$email_content = '
						<table align="center" width="700" cellspacing="1" cellpadding="0" style="border: 1px solid #CCCCCC; border-collapse: collapse; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">						  
						  <tr>
							<td valign="middle" align="center" style="background-color:#f2f4f4;">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td align="center" style="background-color:#f2f4f4; position:relative; -moz-transition:all 1s ease-in 0s; -webkit-transition:all 1s; -o-transition:all 1s;"><a href="'.WEBSITE_URL.'" target="_blank"><img src="'.WEBSITE_URL.'/'.$WEBSITE_LOGO.'" border="0" /></a></td>
									</tr>
									<tr>
										<td height="10" style="background-color:#f2f4f4; position:relative; -moz-transition:all 1s ease-in 0s; -webkit-transition:all 1s; -o-transition:all 1s;"></td>
									</tr>									
						...
						/*<tr>
								<td height="30" align="center" valign="middle" style="background-color:#3f3f3f; color:#fff;">&nbsp;<b>DONATION RECEIPT</b></td>
						  </tr>
						  */
		$email_content.= '<tr>
						  		 <td height="10">&nbsp;</td>
