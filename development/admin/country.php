					...
					<tbody>
                     ...
                     <td><div align="center"><a href="<?php echo CP;?>?index=Edit&Id=<?php echo $country_id;?>" class="btn btn-primary btn-mini">Edit</a> <a href="#myAlert<?php echo $country_id;?>" data-toggle="modal" class="btn btn-danger btn-mini">Delete</a></div></td>
						...
						<div id="myAlert<?php echo $row['country_id'];?>" class="modal hide">
							...
							<div class="modal-footer"> <a class="btn btn-primary" href="<?php echo CP;?>?index=List&action=Delete&Id=<?php echo $country_id;?>&lang_name=<?php echo $f->getValue($row['language_name']);?>&file=<?php echo $row['pro_img'];?>">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
						</div>
					<?php 
							}
						} else { 
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">	            				
					<div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="country_name" id="country_name" class="span11 required" value="<?php echo $_POST['country_name'];?>" />
						</div>
					</div>
               <!--<div class="control-group">
