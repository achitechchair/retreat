...
?>
			<li <?php if($SubCurrPage == basename($_SERVER['PHP_SELF'])) echo ' class="active"';?> id="<?php echo $DivId2;?>"><a href="<?php echo WEBSITE_URL."/".$SubVal;?>" title="<?php echo $SubKey;?>"><i class="icon icon-chevron-right"></i><span class="Font13"><?php echo $SubKey;?></span></a></li>
<?php
