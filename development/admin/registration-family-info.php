<?php
	...
	{
		if(empty($_FILES['family_photo']['name'])==FALSE && $_POST['f_photo'] == 'Yes')
		{
			...
			$family_photo = $_POST['old_family_photo'];
		}
		
		if($_POST['f_photo'] == 'No' && $_POST['s_photo'] == 'No')
		{
			$family_photo = '';
			$files = "../".REG_DOCUMENT.'/'.$_POST['old_family_photo'];
			$f->DeleteFile($files);	
		}
               ...
               <div class="FPhoto">            				
                  <div class="control-group">
                     ...
                     <div class="controls">							
                           ...
                           <img src="<?php echo MAIN_WEBSITE_URL;?>/phpThumb/phpThumb.php?src=<?php echo MAIN_WEBSITE_URL;?>/<?php echo $family_photos;?>&w=140&h=140&zc=1" class="FPhoto" alt="" /><br /><br />
                           <?php } ?>
