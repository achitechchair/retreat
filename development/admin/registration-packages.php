					...
					<tbody>
                     ...
                     <td><div align="center">
						...
						<div id="myAlert<?php echo $row['reg_pack_id'];?>" class="modal hide">
							...
							<div class="modal-footer"> <a class="btn btn-primary" href="<?php echo CP;?>?index=List&action=Delete&Id=<?php echo $reg_pack_id;?>&lang_name=<?php echo $f->getValue($row['language_name']);?>&file=<?php echo $row['pro_img'];?>">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
						</div>
					<?php 
							}
						} else { 
		...
		<div class="row-fluid">
			<div class="widget-box">
               ...
               <div class="control-group">
						...
						<div class="controls">					
                     <textarea name="package_title" class="span11 required ckeditor" id="package_title"><?php echo $_POST['package_title'];?></textarea>
						</div>
					</div>
               ...
               <div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="package_price_old" id="package_price_old" class="span11 numeric" value="<?php echo $_POST['package_price_old'];?>" />
                  </div>                  
					</div>
               ...
               <div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="no_of_people" id="no_of_people" class="span11 required number_only" value="<?php echo $_POST['no_of_people'];?>" />
                  </div>                  
					</div>
               ...
               <div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="youth_include_people" id="youth_include_people" class="span11 required number_only" value="<?php echo $_POST['youth_include_people'];?>" />
                  </div>                  
					</div>
               ...
               <div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="banquet_dinner_include_people" id="banquet_dinner_include_people" class="span11 required number_only" value="<?php echo $_POST['banquet_dinner_include_people'];?>" />
                  </div>                  
					</div>   
               ...
               <div class="control-group">
						...
						<div class="controls">							
							<input type="text" name="room_for_nights" id="room_for_nights" class="span11 required number_only" value="<?php echo $_POST['room_for_nights'];?>" />
                  </div>                  
					</div>
