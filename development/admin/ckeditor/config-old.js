...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Flash,PasteText,PasteFromWord,Smiley,Table,Form,About,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,CreateDiv,Iframe,PageBreak,ShowBlocks,Find,Replace,SelectAll,SpellChecker,Scayt,Save,NewPage,DocProps,Preview,Print,Templates,FontSize,Font';
