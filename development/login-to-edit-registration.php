               ...
               <form name="frm" id="frm" method="post" action="<?php echo MAIN_WEBSITE_URL;?>/login-to-edit-registration">
                    ...
                    <div class="register_area">
                         ...
                         <div>
                              ...
                              <input name="ref_number" id="ref_number" value="<?php echo $_POST['ref_number'];?>" type="text" placeholder="" class="input1" required />
                         </div>
                          <div>
                              <p class="style1">Enter Your Email</p>
                              <input name="email_id" id="email_id" value="<?php echo $_POST['email_id'];?>" type="email" placeholder="" class="input1 email" required />
                         </div>
                         <div class="recaptcha">
