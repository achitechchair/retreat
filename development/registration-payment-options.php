		...
		<div class="inner_container" style="max-width: 700px;">
         ...
         <?php } ?>
			<div class="register_area">
				...
				<div class="input_radio"><input type="radio" name="pay_mode" class="pay_opt" value="Check">  Check <span style="font-weight:500">($<?php echo round($total_price);?>)</span>&nbsp;<a href="" data-toggle="modal" data-target="#check_info">How to pay by Check</a></div>				
