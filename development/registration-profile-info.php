		...
		<div class="inner_container">
         ...
         <form name="reg_frm" id="reg_frm" method="post" action="<?php echo MAIN_WEBSITE_URL?>/registration-profile-info">
            <div class="register_area">
               <div class="row">
                  <div class="col-md-6"><p class="style1">Email <span>*</span></p><input name="email_id" id="email_id" type="email" value="<?php echo $_POST['email_id'];?>" placeholder="" class="input3 email" required /></div>
                  <div class="col-md-6"><p class="style1">Mobile <span>*</span></p><input name="phone" id="phone" type="tel" value="<?php echo $_POST['phone']?>" placeholder="" class="input3" maxlength="20" required /></div>	
               </div>
               <div><p class="style1">Address Line 1 <span>*</span></p><input name="address_1" id="address_1" type="text" value="<?php echo $_POST['address_1'];?>" placeholder="" class="input3" required /></div>
               <div><p class="style1"> Address Line 2</p><input name="address_2" id="address_2" type="text" value="<?php echo $_POST['address_2'];?>" placeholder="" class="input3" /></div>
               <div class="row">
                  ...
                  <div class="col-md-6"><p class="style1">City <span>*</span></p><input name="city" id="city" type="text" value="<?php echo $_POST['city'];?>" placeholder="" class="input3" required /></div>
                  <div class="col-md-6"><p class="style1">Zip Code <span>*</span></p><input name="zip_code" id="zip_code" type="text" value="<?php echo $_POST['zip_code'];?>" placeholder="" class="input3" maxlength="6" required /></div>
