	...
	<div class="container"> 
   	<form name="frm" id="frm" method="post" action="<?php echo MAIN_WEBSITE_URL;?>/registration-payment-options">
		<div class="inner_container" style="max-width: 700px;">
         ...
         <?php if($_GET['msg'] == 'PaymentErrorPayPal'){ ?>
               <div class="clear"></div>
         ...
         <?php } ?>
			<div class="register_area">
				<div class="input_radio"><input type="radio" name="pay_mode" class="pay_opt" value="Zelle"<?php if($_GET['msg'] != 'PaymentErrorPayPal') echo ' checked'?>>  Zelle Pay - <span style="font-weight:400">jointtreasurer@achi.org</span> <span style="font-weight:500">($<?php echo round($total_price);?>)</span>&nbsp;<a href="<?php echo MAIN_WEBSITE_URL;?>/pay-info/?page_id=<?php echo $f->EncryptDecrypt('2');?>" target="_blank">How to pay by zelle</a></div>
				<div class="input_radio"><input type="radio" name="pay_mode" class="pay_opt" value="Check">  Check <span style="font-weight:500">($<?php echo round($total_price);?>)</span>&nbsp;<a href="<?php echo MAIN_WEBSITE_URL;?>/pay-info/?page_id=<?php echo $f->EncryptDecrypt('3');?>" target="_blank">How to pay by Check</a></div>				
            <div class="input_radio"><input type="radio" name="pay_mode" class="pay_opt" value="PayPal"<?php if($_GET['msg'] == 'PaymentErrorPayPal') echo ' checked'?>>  PayPal <span style="font-weight:500">($<?php echo $total_price_paypal;?>)</span></div>
				<br>
            ...
            <p style="margin-top:20px;">YOUR REGISTRATION NUMBER IS <b><?php echo $ref_number;?></b><br />If you want to modify your registration, please use your email and the above registration number.</p>
				<p><b>Please Note:</b> Registration is not marked complete until your payment is received.</p>
         </div>
		</div>
      </form>
	<div class="clear"></div>
