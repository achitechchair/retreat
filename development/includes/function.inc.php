<?php
	class Functions extends Security
	{
		...
		public function getEditor($width='600', $height='500',$fileBrowser,$linkBrowser,$REPLACE,$group, $obj='oEdit1')
		{
			echo "<script type=\"text/javascript\">
			var ".$obj." = new InnovaEditor('".$obj."');
			
			".$obj.".width = '".$width."';
			".$obj.".height = '".$height."';
			
			/*Add Custom Buttons */
			".$obj.".arrCustomButtons.push([\"MyCustomButton\", \"alert('Custom Command here..')\", \"Caption..\", \"btnCustom1.gif\"]);
			...
			".$obj.".cmdInternalLink = \"modalDialog('".$linkBrowser."/my_custom_dialog.htm',650,350)\"; //Command to open your custom link browser.
			".$obj.".cmdCustomObject = \"modalDialog('".$linkBrowser."/my_custom_dialog.htm',650,350)\"; //Command to open your custom file browser.
			
			/*Enable Custom File Browser 
			".$obj.".fileBrowser = '".$fileBrowser."';*/
			...
			".$obj.".returnKeyMode = 2;
			".$obj.".pasteTextOnCtrlV = false;
			".$obj.".enableCssButtons = false;
			
			".$obj.".enableFlickr = false;
			/*Render the editor*/
			".$obj.".css = \"/styles/default.css\";
			".$obj.".REPLACE('".$REPLACE."');
			</script>";	
		}
