...
<section class="inner_area"> 
	<div class="container">    	
		<div class="inner_container" style="max-width: 700px;"> 
			<div style="font-size:25px;color:#2F2D9B; font-weight:600; text-transform:uppercase; padding-bottom:30px;">Small group networking event <span style="font-size:18px; text-transform:none;">($50 per person)</span></div>
         
         <form name="frm" id="frm" method="post" action="<?php echo MAIN_WEBSITE_URL;?>/registration-youth-networking-event">
            <div class="register_area">
               <p>Hi, any Member in your party interested in Small Group Youth  Networking Event Sunday July 7th 9 am - 1 pm (<a href="<?php echo MAIN_WEBSITE_URL;?>/images/youth-networking.jpg" class="fancybox">Click Here</a> for More Info)</p>
               <?php 
