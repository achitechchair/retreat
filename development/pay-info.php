<?php 
	...
	$page_id = $f->EncryptDecrypt($_GET['page_id'], 'decrypt');
	
	$sql_content = "SELECT * FROM `tbl_static_page_content` WHERE `page_id`='".$page_id."'";
    ...
    <div class="flexcaption">
        <div class="container">
            <div class="flexcaption_area">
                <div class="flexcaption_style4"><?php echo $f->getValue($row_content['page_title']);?></div>
            </div>
        </div>
    </div>
	<div class="clear"></div>
