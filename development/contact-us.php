	...
	<div class="container">
			<div class="contact_area">
               ...
               <input type="text" name="_ARcv0weh4043qfgpm1rx8j42kisb9atzo7Cbary" class="DispNone">
                  <div><p class="style1">Name <span>*</span></p><input name="yname" id="yname" type="text" placeholder="" value="<?php echo $_POST['yname'];?>" class="input3" required /></div>
                  <div><p class="style1">Email <span>*</span></p><input name="email" id="" type="email" placeholder="" value="<?php echo $_POST['email'];?>" class="input3 email" required /></div>
                  <div><p class="style1">Phone <span>*</span></p><input name="tel" id="" type="tel" placeholder="" value="<?php echo $_POST['tel'];?>" class="input3 email" required /></div>
                  <div><p class="style1">Message <span>*</span></p><textarea name="msg" cols="" rows="" placeholder="" class="input4" required><?php echo $_POST['msg'];?></textarea></div>
                  <div class="recaptcha">
